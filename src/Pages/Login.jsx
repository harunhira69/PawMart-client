...
const Login = () => {
  ...
  return (
   <div className="min-h-screen flex items-center justify-center bg-linear-to-r from-indigo-50 via-white to-pink-50 px-4">
  <div className="w-full max-w-md bg-white p-10 rounded-3xl shadow-xl border border-gray-200">
    ...
    <form onSubmit={handleLogin} className="space-y-6">
      ...
      <button
        type="submit"
        className="w-full bg-indigo-600 text-white py-3 rounded-xl font-semibold shadow-md hover:bg-indigo-700 transition hover:shadow-lg"
      >
        Login
      </button>
    </form>
